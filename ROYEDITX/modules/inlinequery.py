...
from ROYEDITX import user_collection, collection
    ...
    if query.isdigit():
        ...
        if user:
            ...
            for character in characters:
                ...
                rarity = character.get('rarity', "❖ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ʀᴀʀɪᴛʏ...")
